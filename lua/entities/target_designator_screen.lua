...
if SERVER then
    ...
    function ENT:Draw()
        ...
        cam.Start3D2D(pos, ang, 0.2)
            ...
            draw.SimpleText(self:GetNWString("TypingText", "ACQUIRING TARGETS"), "DermaLarge", 0, -190, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
            draw.SimpleText("CURRENT TARGET -", "DermaLarge", 0, -90, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
            draw.SimpleText(self:GetNWString("DisplayText", "No Entities Found"), "TargetId", 0, 0, Color(255, 0, 0), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        cam.End3D2D()
    end
end   
