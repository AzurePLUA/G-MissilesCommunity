...
ENT.PrintName			= "Driveable Tomahawk" 
ENT.Author			= "Forsomethings1"
ENT.Contact			= "Don't"
ENT.Purpose			= "Blow Shit Up"
ENT.Instructions		= "BGM 109 Tomahawk with a chair installed. Use w/a/s/d to steer. Press spacebar to launch while sitting in the seat!"
