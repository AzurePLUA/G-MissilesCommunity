...
ENT.PrintName = "KAB-500L Guided"
ENT.Author = "Forsomethings1"
ENT.Contact = "Don't"
ENT.Purpose = "Blow Shit Up"
ENT.Instructions = "KAB-500L"
ENT.Spawnable = true
ENT.MissileModel = "models/GMissiles/KAB-500L.mdl"
